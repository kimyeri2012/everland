...
$page_num = 3;
//paging :  현재 페이지
$page = isset($_GET["page"])? $_GET["page"] : 1; //처음은 무조건 1페이지 페이지 누르면 해당 페이지로 이동
...
<head>
    ...
    <style>
        ...
        <?php if($s_id =="admin"){?>
            /* 관리자 로그인일 때만  */
        .write_area{width:860px; display: flex; justify-content: space-between;}
        <?php };?>
    ...
    <table class="notice_list_set">
        ...
        ?>
            <tr class="notice_list_content">
                ...
                <td class="writer"><?php echo $array["writer"] ?> </td>
                <?php $w_date = substr($array["w_date"], 0, 10); ?>
                <td class="w_date"><?php echo $w_date; ?></td>
